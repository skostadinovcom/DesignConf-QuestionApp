...
@section('page_title', 'Редактиране на страница: ' . $page->title )
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ url('admin/page/' . $page->id ) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <h1 class="page_title">Редактиране на страница: {{ $page->title }}</h1>
                        @if ($errors->any())
                        ...
                        <div class="input-field" style="margin-top: 25px;">
                            <input placeholder="Пример: Програма" id="post_title" type="text" class="validate" name="title" value="{{ $page->title }}">
                        ...
                        <div class="input-field" style="margin-top: 25px;">
                            ...
                            <input placeholder="Пример: shedudle" id="post_url" type="text" class="validate" name="url" value="{{ $page->url }}">
                            <label for="post_url">Линк на страницата:</label>
                        </div>
                        <div class="input-field" style="margin-top: 25px;">
                            <span style="font-size: 10px;">Полето чете и HTML</span>
                            <textarea id="post_content" class="materialize-textarea editor" placeholder="1. Откриване" name="desc">{!! $page->content !!}</textarea>
